...
namespace PizzeriaSconosciuto
{
    ...
    partial void DeleteZamowienia(Zamowienia instance);
		...
		public System.Data.Linq.Table<Dostawa_Skladnik> Dostawa_Skladnik
		{
			get
			{
		...
		public System.Data.Linq.Table<Dostawcy> Dostawcy
		{
			get
			{
		...
		public System.Data.Linq.Table<Dostawy> Dostawy
		{
			get
			{
		...
		public System.Data.Linq.Table<Kontrakt> Kontrakt
		{
			get
			{
		...
		public System.Data.Linq.Table<Produkty_Zamowienia> Produkty_Zamowienia
		{
			get
			{
				return this.GetTable<Produkty_Zamowienia>();
			}
		}
		
		public System.Data.Linq.Table<Skladniki> Skladniki
		{
			get
			{
	...
	public partial class Adres : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Dostawcy> _Dostawcy;
		
		private EntitySet<Pracownicy> _Pracownicy;
		
		private EntitySet<Zamowienia> _Zamowienia;
    ...
    partial void OnKrajChanged();
		...
		public Adres()
		{
			this._Dostawcy = new EntitySet<Dostawcy>(new Action<Dostawcy>(this.attach_Dostawcy), new Action<Dostawcy>(this.detach_Dostawcy));
			this._Pracownicy = new EntitySet<Pracownicy>(new Action<Pracownicy>(this.attach_Pracownicy), new Action<Pracownicy>(this.detach_Pracownicy));
			this._Zamowienia = new EntitySet<Zamowienia>(new Action<Zamowienia>(this.attach_Zamowienia), new Action<Zamowienia>(this.detach_Zamowienia));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Adres_Dostawcy", Storage="_Dostawcy", ThisKey="AdresID", OtherKey="AdresID")]
		public EntitySet<Dostawcy> Dostawcy
		{
			get
			{
				return this._Dostawcy;
			}
			set
			{
				this._Dostawcy.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Adres_Pracownicy", Storage="_Pracownicy", ThisKey="AdresID", OtherKey="AdresID")]
		public EntitySet<Pracownicy> Pracownicy
		{
			get
			{
				return this._Pracownicy;
			}
			set
			{
				this._Pracownicy.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Adres_Zamowienia", Storage="_Zamowienia", ThisKey="AdresID", OtherKey="AdresID")]
		public EntitySet<Zamowienia> Zamowienia
		{
			get
			{
		...
		private void attach_Dostawcy(Dostawcy entity)
		{
			this.SendPropertyChanging();
			entity.Adres = this;
		}
		
		private void detach_Dostawcy(Dostawcy entity)
		{
			this.SendPropertyChanging();
			entity.Adres = null;
		}
		
		private void attach_Pracownicy(Pracownicy entity)
		{
			this.SendPropertyChanging();
			entity.Adres = this;
		}
		
		private void detach_Pracownicy(Pracownicy entity)
		{
			this.SendPropertyChanging();
			entity.Adres = null;
		}
		
		private void attach_Zamowienia(Zamowienia entity)
		{
			this.SendPropertyChanging();
			entity.Adres = this;
		}
		
		private void detach_Zamowienia(Zamowienia entity)
		{
			this.SendPropertyChanging();
			entity.Adres = null;
		}
	...
	public partial class Dostawcy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Dostawy> _Dostawy;
    ...
    partial void OnNazwaChanged();
		...
		public Dostawcy()
		{
			this._Dostawy = new EntitySet<Dostawy>(new Action<Dostawy>(this.attach_Dostawy), new Action<Dostawy>(this.detach_Dostawy));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Dostawcy_Dostawy", Storage="_Dostawy", ThisKey="NIP", OtherKey="NIP")]
		public EntitySet<Dostawy> Dostawy
		{
			get
			{
				return this._Dostawy;
			}
			set
			{
				this._Dostawy.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Adres_Dostawcy", Storage="_Adres", ThisKey="AdresID", OtherKey="AdresID", IsForeignKey=true)]
		public Adres Adres
		{
			get
			{
			...
			set
			{
							...
							|| (this._Adres.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Dostawcy.Remove(this);
					}
					this._Adres.Entity = value;
					if ((value != null))
					{
						value.Dostawcy.Add(this);
		...
		private void attach_Dostawy(Dostawy entity)
		{
			this.SendPropertyChanging();
			entity.Dostawcy = this;
		}
		
		private void detach_Dostawy(Dostawy entity)
		{
			this.SendPropertyChanging();
			...
			set
			{
							...
							|| (this._Dostawcy.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Dostawy.Remove(this);
					}
					this._Dostawcy.Entity = value;
					if ((value != null))
					{
						value.Dostawy.Add(this);
						this._NIP = value.NIP;
					}
					else
					{
		...
		public Pracownicy Pracownicy
		{
			...
			set
			{
							...
							|| (this._Pracownicy.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Pracownicy.Entity = null;
						previousValue.Kontrakt.Remove(this);
					}
					this._Pracownicy.Entity = value;
					if ((value != null))
					{
						value.Kontrakt.Add(this);
						this._PracownikID = value.PracownikID;
					}
					else
					{
	...
	public partial class Pracownicy : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Grafik> _Grafik;
		
		private EntitySet<Kontrakt> _Kontrakt;
		
		private EntitySet<Zamowienia> _Zamowienia;
		
		private EntitySet<Zamowienia> _Zamowienia1;
    ...
    partial void OnTelefonChanged();
		...
		public Pracownicy()
		{
			this._Grafik = new EntitySet<Grafik>(new Action<Grafik>(this.attach_Grafik), new Action<Grafik>(this.detach_Grafik));
			this._Kontrakt = new EntitySet<Kontrakt>(new Action<Kontrakt>(this.attach_Kontrakt), new Action<Kontrakt>(this.detach_Kontrakt));
			this._Zamowienia = new EntitySet<Zamowienia>(new Action<Zamowienia>(this.attach_Zamowienia), new Action<Zamowienia>(this.detach_Zamowienia));
			this._Zamowienia1 = new EntitySet<Zamowienia>(new Action<Zamowienia>(this.attach_Zamowienia1), new Action<Zamowienia>(this.detach_Zamowienia1));
			this._Adres = default(EntityRef<Adres>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pracownicy_Grafik", Storage="_Grafik", ThisKey="PracownikID", OtherKey="PracownikID")]
		public EntitySet<Grafik> Grafik
		{
			get
			{
				return this._Grafik;
			...
			set
			{
				this._Grafik.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pracownicy_Kontrakt", Storage="_Kontrakt", ThisKey="PracownikID", OtherKey="PracownikID")]
		public EntitySet<Kontrakt> Kontrakt
		{
			get
			{
				return this._Kontrakt;
			}
			set
			{
				this._Kontrakt.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pracownicy_Zamowienia", Storage="_Zamowienia", ThisKey="PracownikID", OtherKey="KierowcaID")]
		public EntitySet<Zamowienia> Zamowienia
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pracownicy_Zamowienia1", Storage="_Zamowienia1", ThisKey="PracownikID", OtherKey="KucharzID")]
		public EntitySet<Zamowienia> Zamowienia1
		{
			get
			{
				return this._Zamowienia1;
			}
			set
			{
				this._Zamowienia1.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Adres_Pracownicy", Storage="_Adres", ThisKey="AdresID", OtherKey="AdresID", IsForeignKey=true)]
		public Adres Adres
		{
			get
			{
			...
			set
			{
							...
							|| (this._Adres.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Adres.Entity = null;
						previousValue.Pracownicy.Remove(this);
					}
					this._Adres.Entity = value;
					if ((value != null))
					{
						value.Pracownicy.Add(this);
						this._AdresID = value.AdresID;
					}
					else
					{
		...
		private void attach_Grafik(Grafik entity)
		{
			this.SendPropertyChanging();
			entity.Pracownicy = this;
		}
		
		private void detach_Grafik(Grafik entity)
		{
			this.SendPropertyChanging();
			entity.Pracownicy = null;
		}
		
		private void attach_Kontrakt(Kontrakt entity)
		{
			this.SendPropertyChanging();
			entity.Pracownicy = this;
		}
		
		private void detach_Kontrakt(Kontrakt entity)
		{
			this.SendPropertyChanging();
			entity.Pracownicy = null;
		}
		...
		private void attach_Zamowienia1(Zamowienia entity)
		{
			this.SendPropertyChanging();
			entity.Pracownicy1 = this;
		}
		
		private void detach_Zamowienia1(Zamowienia entity)
		{
			this.SendPropertyChanging();
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Produkty_Zamowienia")]
	public partial class Produkty_Zamowienia
	{
		...
		public Produkty_Zamowienia()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IdProduktu", DbType="Int NOT NULL")]
		public int IdProduktu
		{
			get
			{
    ...
    partial void OnTelefonChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Adres_Zamowienia", Storage="_Adres", ThisKey="AdresID", OtherKey="AdresID", IsForeignKey=true)]
		public Adres Adres
		{
			get
			{
			...
			set
			{
							...
							|| (this._Adres.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Adres.Entity = null;
						previousValue.Zamowienia.Remove(this);
					}
					this._Adres.Entity = value;
					if ((value != null))
					{
						value.Zamowienia.Add(this);
						this._AdresID = value.AdresID;
					}
					else
					{
			...
			set
			{
							...
							|| (this._Pracownicy1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Zamowienia1.Remove(this);
					}
					this._Pracownicy1.Entity = value;
					if ((value != null))
					{
						value.Zamowienia1.Add(this);
